    ...
    <div class="center" >
      <span class="top" >扫码点单客户端</span>
        <el-form ref="form" :model="form" label-width="80px"  style="margin-left:80px;" >
          ...
          <el-input v-model="form.account" size="mini" style="width:200px;" @change="verifyPhone" ></el-input>
        </el-form-item>
          <el-form-item label="密码">
          <el-input v-model="form.password" show-password size="mini" style="width:200px;" @change="verifypassWord" ></el-input>
        </el-form-item>
        </el-form>
        <div class="dianji" ><el-button @click="goToShop" :loading="loading" >点击登录</el-button></div>
        <div class="below">
